...
const Footer = () => {
    return (
        <div>
            <section className='bg-slate-800 text-left'>
                <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                    <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 md:grid-cols-4">
                        {/* footer left side  */}
                        <div className="sm:col-span-2">
                            <Link to='/'><p className='text-2xl'>Auto<span className='text-cyan-500'>Ment</span></p></Link>
                            <div className="mt-6 lg:max-w-sm opacity-70 font-light">
                                <p className="text-sm">
                                    AutoMent is Car Dealer Company, Successfully running business from 1995.
                                </p>
                                <p className="mt-4 text-sm">
                                    In this cutting edge technology modern people's first choice is AutoMent.
                                </p>
                            </div>
                        </div>
                        {/* footer right side  */}
                        <div className="space-y-2 text-sm">
                            {/* Contacts */}
                            <p className="text-base font-bold tracking-wide text-cyan-500">
                                Contacts
                            </p>
                            <div className="flex">
                        ...
                        {/* Social */}
                        <div>
                            <span className="text-base font-bold tracking-wide text-cyan-500">
                                Social Media
                            </span>
                            <div className="flex items-center mt-1 space-x-3">
                                <a
                                    href="https://twitter.com/sdshuvo9898"
                                    target="_blank"
                                    rel="noreferrer"
                    ...
                    <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
                        <p className="text-sm text-gray-600">
                            © Copyright 2022 AutoMent. All rights reserved.
                        </p>
